...
/* package mustache-2.4.2 */
#ifndef VERSION_mustache
#define VERSION_mustache "2.4.2"
...
/* package persistable-record-0.6.0.5 */
#ifndef VERSION_persistable_record
#define VERSION_persistable_record "0.6.0.5"
#endif /* VERSION_persistable_record */
#ifndef MIN_VERSION_persistable_record
#define MIN_VERSION_persistable_record(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  6 || \
  (major1) == 0 && (major2) == 6 && (minor) <= 0)
#endif /* MIN_VERSION_persistable_record */
/* package relational-query-0.12.3.0 */
#ifndef VERSION_relational_query
#define VERSION_relational_query "0.12.3.0"
#endif /* VERSION_relational_query */
#ifndef MIN_VERSION_relational_query
#define MIN_VERSION_relational_query(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  12 || \
  (major1) == 0 && (major2) == 12 && (minor) <= 3)
#endif /* MIN_VERSION_relational_query */
/* package relational-query-HDBC-0.7.2.0 */
#ifndef VERSION_relational_query_HDBC
#define VERSION_relational_query_HDBC "0.7.2.0"
#endif /* VERSION_relational_query_HDBC */
#ifndef MIN_VERSION_relational_query_HDBC
#define MIN_VERSION_relational_query_HDBC(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  7 || \
  (major1) == 0 && (major2) == 7 && (minor) <= 2)
#endif /* MIN_VERSION_relational_query_HDBC */
...
#define CURRENT_PACKAGE_KEY "weight-recorder-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "weight-recorder-0.1.0.0-inplace"
